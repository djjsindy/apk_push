...
public class Base64_EXT {
	 ...
	 *            Specified options
	 * @return The Base64-encoded object
	 * @see com.sohu.mobile.push.util.Base64_EXT#GZIP
	 * @see com.sohu.mobile.push.util.Base64_EXT#DO_BREAK_LINES
	 * @throws java.io.IOException
	 *             if there is an error
	 * @since 2.0
	 */
	...
	public static void encodeToFile(byte[] dataToEncode, String filename) throws java.io.IOException {
		...
		try {
			bos = new OutputStream(new java.io.FileOutputStream(filename), Base64_EXT.ENCODE);
	...
	public static void decodeToFile(String dataToDecode, String filename) throws java.io.IOException {
		...
		OutputStream bos = null;
		try {
			bos = new OutputStream(new java.io.FileOutputStream(filename), Base64_EXT.DECODE);
	...
	/**
	 * A {@link com.sohu.mobile.push.util.Base64_EXT.InputStream} will read data from another <tt>java.io.InputStream</tt>, given in the
	 * constructor, and encode/decode to/from Base64 notation on the fly.
	 * 
	 * @see com.sohu.mobile.push.util.Base64_EXT
	 * @since 1.3
	 */
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Constructs a {@link com.sohu.mobile.push.util.Base64_EXT.InputStream} in DECODE mode.
		 * 
		 * @param in
		...
		/**
		 * Constructs a {@link com.sohu.mobile.push.util.Base64_EXT.InputStream} in either ENCODE or DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 * <pre>
		 ...
		 * @param options
		 *            Specified options
		 * @see com.sohu.mobile.push.util.Base64_EXT#ENCODE
		 * @see com.sohu.mobile.push.util.Base64_EXT#DECODE
		 * @see com.sohu.mobile.push.util.Base64_EXT#DO_BREAK_LINES
		 * @since 2.0
		 */
	...
	/**
	 * A {@link com.sohu.mobile.push.util.Base64_EXT.OutputStream} will write data to another <tt>java.io.OutputStream</tt>, given in the
	 * constructor, and encode/decode to/from Base64 notation on the fly.
	 * 
	 * @see com.sohu.mobile.push.util.Base64_EXT
	 * @since 1.3
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		...
		/**
		 * Constructs a {@link com.sohu.mobile.push.util.Base64_EXT.OutputStream} in ENCODE mode.
		 * 
		 * @param out
		...
		/**
		 * Constructs a {@link com.sohu.mobile.push.util.Base64_EXT.OutputStream} in either ENCODE or DECODE mode.
		 * <p>
		 * Valid options:
		 * 
		 * <pre>
